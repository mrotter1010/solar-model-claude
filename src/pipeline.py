...
class SolarModelingPipeline:
    ...
    def _apply_subhourly_correction(
        ...
        Delegates to the shared helper in src.optimization.clipping_correction
        so the same logic can be used by the layout optimizer without
        instantiating a Pipeline object.
        ...
        """
        return apply_subhourly_clipping_correction(result, site)
